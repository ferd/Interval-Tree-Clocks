...
%% Testing the demo code from README.md to make
...
%% Test that the text from README about replicating Version Vectors
...
comparison(_Config) ->
    ...
    %% representing concurrent results. They however remain joinable.
